...
public final class GeofenceUtils {
    ...
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "com.mns.walker.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "com.mns.walker.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "com.mns.walker.EXTRA_GEOFENCE_STATUS";

    /*
     * Keys for flattened geofences stored in SharedPreferences
     */
    public static final String KEY_LATITUDE = "com.mns.walker.KEY_LATITUDE";

    public static final String KEY_LONGITUDE = "com.mns.walker.KEY_LONGITUDE";

    public static final String KEY_RADIUS = "com.mns.walker.KEY_RADIUS";

    public static final String KEY_EXPIRATION_DURATION =
            "com.mns.walker.KEY_EXPIRATION_DURATION";

    public static final String KEY_TRANSITION_TYPE =
            "com.mns.walker.KEY_TRANSITION_TYPE";
